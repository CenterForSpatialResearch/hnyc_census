...
edict <- read_csv("~/Desktop/HNYC_census_processing/hnyc_census-master/Data/full_bk_dict.csv")
sample <- read_csv("~/Desktop/HNYC_census_processing/hnyc_census-master/Data/census_1910_h_bk.csv")
hn_dict <- read_csv("~/Desktop/HNYC_census_processing/hnyc_census-master/Data/combine_bk.csv")
...
```{r}
output
write.csv(output, file = "bk_output.csv")
saveRDS(output, file = "bk_output.rds")
```