...
# 6. Next Steps
1. Further EDA on errors detected by house number ranges, nothing that these may instead reflect bad matches derived from the address cleaning process. This likely involves further diving into the original manuscripts and coming up with a typology of errors and actions.

2. To incorporate various errors into code. Some ideas for known errors (found in Section 5):
