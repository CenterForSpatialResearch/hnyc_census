...
For fill down, the recommended step is take a lookaround of 3 streets in the top/bottom of the row in the same ED and match using jw. Records can then be manually cleaned.