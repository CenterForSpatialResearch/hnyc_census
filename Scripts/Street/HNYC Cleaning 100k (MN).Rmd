...
EDict_MN$cleaned<-gsub("\\<RO\\>|\\<ROM\\>|\\<RON\\>","ROW",EDict_MN$cleaned)
EDict_MN$cleaned<-gsub("\\<SLP\\>|\\<SLEP\\>|\\<SLIIP\\>","SLIP",EDict_MN$cleaned)
...
str_clean<-function(x){
  ...
  x$cleaned<-gsub("\\<RO\\>|\\<ROM\\>|\\<RON\\>","ROW",x$cleaned)
  x$cleaned<-gsub("\\<SLP\\>|\\<SLEP\\>|\\<SLIIP\\>","SLIP",x$cleaned)
