...
edict <- read_csv("https://raw.githubusercontent.com/CenterForSpatialResearch/hnyc_census/master/1880/Street_Dict/full_bk_dict_1880.csv")
hn_dict <- read_csv("https://raw.githubusercontent.com/CenterForSpatialResearch/hnyc_census/master/1880/Street_Dict/combine_bk_1880.csv") %>%
